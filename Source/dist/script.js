...
/* harmony import */ var _modules_btnStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/btnStyles */ "./src/js/modules/btnStyles.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_btnStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', arr);
...
var accordion = function accordion(triggersSelector) {
  ...
  }); //   blocks = document.querySelectorAll(itemsSelector);   //через css стили
...
var btnStyles = function btnStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // styles.forEach(item => {   //простая подгрузка без сервера
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') //это вместо ссылки, просто путь, однако если так делать, в createcards нужно указать styles, так как в db она есть
    .then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (btnStyles);
...
var calc = function calc(size, material, options, promo, result, arr) {
  //неплохо было бы вернуться и подключить цены из db.json
  var selectorSize = document.querySelector(size),
  ...
  selectorMaterial.addEventListener('change', function () {
    calcPrice();
    arr.material = selectorMaterial.value;
    arr.price = resultPrice;
    console.log(arr);
  });
  selectorOptions.addEventListener('change', function () {
    calcPrice();
...
var filter = function filter() {
  ...
  var filterFunc = function filterFunc(selector) {
    //сделать так, чтобы работали блок no на грандмазер, убрать селектор markall
    var button = menu.querySelector(selector);
    var markType = wrapper.querySelectorAll(selector);
...
/* harmony default export */ __webpack_exports__["default"] = (filter); // const typeFilter = (markType) => {
...
var scrolling = function scrolling(upSelector) {
  ...
  }); // Scrolling w/ request animation frame
...
var showPics = function showPics(imgSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (showPics);
